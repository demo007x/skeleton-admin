    ...
    <el-row :gutter="20" type="flex">
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <el-tree ref="tree" class="filter-tree" default-expand-all :filter-node-method="filterNode" :data="list" :props="defaultProps" accordion :highlight-current="true" :expand-on-click-node=false @node-click="handleNodeClick">
